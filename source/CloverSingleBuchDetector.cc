...
CloverSingleBuchDetector::CloverSingleBuchDetector(G4VPhysicalVolume* p_mother, 
                                                   G4Transform3D p_transformation, 
                                                   G4int p_cl_nb, 
                                                   G4int p_cr_nb, 
                                                   G4VisAttributes* pvis_att)
  :mother(p_mother), cl_nb(p_cl_nb), cr_nb(p_cr_nb), transformation(p_transformation), det_vis_att(pvis_att)
{

}
CloverSingleBuchDetector::~CloverSingleBuchDetector() 
{; }



G4VPhysicalVolume* CloverSingleBuchDetector::Construct()
{
    // Material
    //
